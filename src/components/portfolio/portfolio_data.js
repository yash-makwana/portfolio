...
const data = [
    {
        ...
        title: 'Design to Cost (D2C)',
        github: 'https://github.com/yash-makwana',
        description: 'Implemented a cost-efficient predictive model pipeline using Dataiku, focusing on data cleaning, statistical analysis (ANOVA), and machine learning optimization.'
    },
    {
        id: 2,
        img: '', // No image available
        title: 'Smart Troubleshooting (STS)',
        github: 'https://github.com/yash-makwana',
        description: 'Developed an NLP-based system to match queries with past issues, improving problem resolution efficiency. Optimized code for performance and resource management.'
    },
    {
        id: 3,
        img: '', // No image available
        title: 'Tender Benchmark (TBT)',
        github: 'https://github.com/yash-makwana',
        description: 'Built a cost estimation pipeline using regression models (Linear, SVM, XGBoost, etc.). Optimized predictions using R² score, MAPE, and MAE.'
    },
    {
        id: 4,
        img: '', // No image available
